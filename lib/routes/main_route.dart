                  ...
                  Padding(
                    ...
                    child: Obx(() => Column(
                      children: <Widget>[
                        ...
                        GestureDetector(
                          child: Text(
                            appController.userInfo.value.user != null
                                ? appController.userInfo.value.user!.nickname!
                                : goLogin.tr,
                        ...
                        Text(
                          "${grade.tr}:${appController.userInfo.value.coinInfo != null ? appController.userInfo.value.coinInfo!.level! : "--"} ${ranking.tr}:${appController.userInfo.value.coinInfo != null ? appController.userInfo.value.coinInfo!.rank! : "--"}",
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 12,
                          ),
            ...
            Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  trailing: Visibility(
                    visible: appController.isLogin.value,
                    child: Text(
                      appController.userInfo.value.coinInfo != null
                          ? appController.userInfo.value.coinInfo!.coinCount!
                              .toString()
                          : "",
                    ),
                  ),
