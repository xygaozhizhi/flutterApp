...
class _BezierHeaderState extends RefreshIndicatorState<BezierHeader>
  ...
  late AnimationController _bezierBounceCtl, _bezierDismissCtl;

  @override
  void initState() {
    _bezierBounceCtl = AnimationController(
  ...
  void onOffsetChange(double offset) {
    ...
    if (!_bezierBounceCtl.isAnimating || (!floating)) {
      _bezierBounceCtl.value = math.max(0, offset - widget.rectHeight);
    }
  }
  ...
  Future<void> readyToRefresh() {
    final Simulation simulation = SpringSimulation(
        ...
        _bezierBounceCtl.value,
        0,
        1000);
    _bezierBounceCtl.animateWith(simulation);
        ...
        return Stack(
          children: <Widget>[
            ...
            !widget.enableChildOverflow
                ? ClipRect(
                    child: SizedBox(
                      height: (_bezierBounceCtl.isAnimating ||
                                  mode == RefreshStatus.refreshing
                              ? 0
                              : math.max(0, _bezierBounceCtl.value)) +
                          widget.rectHeight,
                      child: widget.child,
                    ),
                  )
